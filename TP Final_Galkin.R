...
#-Fuente: BA Data
#-Web: https://data.buenosaires.gob.ar/dataset/puntos-wi-fi-publicos
...
#-Fuente: INDEC
#-Web: https://www.indec.gob.ar/indec/web/Nivel4-Tema-2-41-165
#-Actualización: 2022
...
#Gestión HRL: 79    Gestión_NHRL:16
...
# "geometry"" que me brinda las coordenadas de cada comuna. Reduzco el archivo a las variables necesarias y le unifico
...
# En esta instancia pretendo resumir el análisis realizado en los TP’s anteriores, para ello, implementaré un mapa
# interactivo que me permita replicar la información analizada anteriormente. Para reflejar la información del TP N° 1,
# proceso la base de Puntos Wi-Fi para posteriormente poder ubicarlos en el mapa según sus coordenadas de longitud y 
# latitud.
...
# Para visualizar la información del TP N° 2, aparte de los mapas generados, pretendo realizar un tercer mapa que
# condense la información anterior e incorpore la variable poblacional para enriquecer el análisis. Para ello, recurro
# a los datos del Censo 2022, dado que los mismos vienen en un archivo tipo Excel, utilizo a la librería “openxlsx” 
...
# Ahora unifico las variables del censo al mapa creado para el TP N° 2, pero antes debo eliminar las variables 
# expresadas en hectáreas ya que las expresaré en kilómetros cuadrados
...
# Ahora genero las paletas de colores para visualizar en forma coroeplética la densidad de Puntos Wi-Fi por kilómetro
# cuadrado según cada gestión y genero una tercer paleta para visualizar la densidad de habitantes por kilómetro 
# cuadrado entre comunas.
...
# Como se puede observar las comunas 1 y 3 son las que mayor densidad de puntos Wi-Fi tienen para cada gestión. Sin
# embargo, en términos de población, las comunas con mayor densidad por Km2 son la 3, 5 y 6. Esto se explica porque la
# comuna 1 es el área central de negocios de la ciudad, si bien no habitan muchas personas, el nivel de circulación 
# diaria más que justifica la alta concentración de Puntos Wi-Fi construidos.

# El resto de la información se puede obtener del mapa, los invito a interactuar con el mismo y clickear sobre las
# comunas o los mismos puntos Wi-Fi para obtener información adicional.